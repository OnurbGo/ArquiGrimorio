...
type BorderColor = string | 'transparent' | 'primary' | 'secondary' | 'brand' | 'info' | 'success' | 'warning' | 'alert' | 'danger';
type ViewOwnProps = {
    /**
...
type ViewProps = ViewOwnProps & WithStyleProps<ViewTheme, ViewStyle> & OtherHTMLAttributes<ViewOwnProps>;
